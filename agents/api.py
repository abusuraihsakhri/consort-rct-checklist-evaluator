"""
FastAPI REST API Server for Consort Rct Checklist Evaluator.
"""
...
app = FastAPI(
    title="Consort Rct Checklist Evaluator API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "consort-rct-checklist-evaluator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
